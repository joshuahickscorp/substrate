...
from mop.studio import generation1_successor_chain_v5 as v5
from mop.studio import generation1_successor_extension_chain_v2 as extension_chain
from mop.studio import generation1_successor_future_chain_v2 as future
...
def _adopter_status(
    ...
    *,
    ...
    capsules = {spec.stage_id: v5.v3._empty_capsule() for spec in v5.legacy_specs(v5.REPO_ROOT)}
    capsules["successor_horizon"] = v5.v3._empty_capsule()
    ...
    implementation = v5._implementation_authority(v5.REPO_ROOT)
    core: dict[str, Any] = {
        "schema": v5.STATUS_SCHEMA,
        "program_id": v5.CHAIN_ID,
        "created_at": NOW,
        "updated_at": NOW,
        "supervisor": {
            "pid": pid,
        ...
        "state": state,
        "horizon_program": v5._horizon_authority(
            v5.DEFAULT_HORIZON_PROGRAM,
            v5.REPO_ROOT,
        ),
        "capsules": capsules,
        "counts": {
...
def _extension_status(
    ...
    *,
    ...
    capsules = {
        "predecessor_chain_v5": extension_chain._empty_row(),
    ...
    if complete:
        ...
        capsules["predecessor_chain_v5"].update(
            {
                "status": "failure_hold",
                "finished_at": NOW,
