...
2. `mop.substrate`: canonical portable model, artifacts, caches, and evidence primitives.
3. `mop.experiments`: sealed historical CM7/CM8 declarations over the shared engine.
