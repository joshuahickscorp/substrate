...
DEFAULT_OUTPUT = REPO_ROOT / "configs/campaign/generation1_evidence_synthesis_recovery_v2_opportunistic.json"
PROGRAM_ID = "generation1-evidence-synthesis-recovery2-opportunistic"
PROGRAM_ROOT = f"runs/generation1/{PROGRAM_ID}"
RECOVERY_PROGRAM_ID = "generation1-empirical-cognitive-corpus-v2-recovery2-opportunistic"
...
def build_program() -> dict[str, Any]:
    ...
    authority_paths = sorted(
        {
            "scripts/build_generation1_opportunistic_synthesis_program.py",
