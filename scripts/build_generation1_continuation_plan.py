#!/usr/bin/env python3
"""Build the sealed recovery-to-synthesis continuation plan."""
...
RECOVERY_PROGRAM = REPO_ROOT / "configs/campaign/generation1_empirical_recovery_v1.json"
SYNTHESIS_PROGRAM = REPO_ROOT / "configs/campaign/generation1_evidence_synthesis_recovery_v1.json"
DEFAULT_OUTPUT = REPO_ROOT / "configs/campaign/generation1_recovery_continuation_v1.json"
ROUTER_ID = "generation1-recovery-to-synthesis-v1"
...
def build_plan() -> dict[str, object]:
    core = {
        ...
        "authorities": [
            _authority("scripts/build_generation1_continuation_plan.py"),
