...
DEFAULT_OUTPUT = REPO_ROOT / "configs/campaign/generation1_empirical_recovery_v4_opportunistic.json"
PROGRAM_ID = "generation1-empirical-cognitive-corpus-v2-recovery4-opportunistic"
...
def build_program() -> dict[str, Any]:
    ...
    authority_paths = sorted(
        {
            "scripts/build_generation1_opportunistic_recovery_v4_program.py",
