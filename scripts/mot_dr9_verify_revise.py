...
Usage: .venv/bin/python scripts/mot_dr9_verify_revise.py --seeds 0-4
"""
...
from mot_mt5_adaptive_halting import make_graded_split, parse_seeds, resolve_out
