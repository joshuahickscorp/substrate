...
mot_cm4_workspace_shell in registry/experiments.yaml, preregistration mirror
configs/experiment/mot_cm4.yaml).
...
Usage: python scripts/mot_cm4_workspace_pilot.py --seeds 0-2
...
from devsys.diagnostics.compute import linear_flops, matched_within, mlp_flops, param_count
...
from devsys.shell.modulation import ContextGating, WorkingMemory
