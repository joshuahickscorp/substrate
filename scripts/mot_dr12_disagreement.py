...
docs/mixture_of_thinking/11_experiment_registry.md, DR full schema part 2).
...
Usage: PYTHONPATH=. python scripts/mot_dr12_disagreement.py --seeds 0-4
...
from devsys.diagnostics.riskcov import auroc, ece_equal_mass, seed_ci, sign_flip_report
...
def run(
    ...
    if degenerate:
        ...
        null_supported = True
    return {
        "experiment": "mot_dr12_disagreement",
        "contract": CONTRACT,
        "config": {
            "seeds": seeds,
            "dim": dim,
