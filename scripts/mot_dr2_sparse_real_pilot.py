...
mot_dr2_sparse_real in registry/experiments.yaml, preregistration mirror configs/experiment/mot_dr2.yaml).
...
Usage: python scripts/mot_dr2_sparse_real_pilot.py --seeds 0-4
...
from devsys.shell.heads import KWTAHead, MoEHead, moe_expert_hidden_for_dense
