...
RECOVERY_PROGRAM = (
    REPO_ROOT / "configs/campaign/generation1_empirical_recovery_v2_opportunistic.json"
)
SYNTHESIS_PROGRAM = (
    REPO_ROOT
    / "configs/campaign/generation1_evidence_synthesis_recovery_v2_opportunistic.json"
)
DEFAULT_OUTPUT = (
    REPO_ROOT / "configs/campaign/generation1_recovery_continuation_v2_opportunistic.json"
)
ROUTER_ID = "generation1-recovery-to-synthesis-v2-opportunistic"
...
def build_plan() -> dict[str, object]:
    core = {
        ...
        "authorities": [
            _authority("scripts/build_generation1_opportunistic_continuation_plan.py"),
