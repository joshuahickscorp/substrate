#!/usr/bin/env python
"""MT5: adaptive halting vs fixed depth at equal AVERAGE FLOPs (H-HALT, WP-03, EXECUTION_MANIFEST).
...
update-norm rule helpers) that mot_mt6_confidence_stop.py and the WP-04 search scripts import.

Form per BLACKHOLE.md: no em dashes or en dashes (commas, colons, parentheses only).

Usage: .venv/bin/python scripts/mot_mt5_adaptive_halting.py --seeds 0-4
"""
...
def train_refiner_and_halt(
    ...
    """Two-phase trainer shared by MT5 and MT6. Phase 1: refiner block + head with deep supervision
