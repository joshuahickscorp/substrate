...
Usage: python scripts/mot_at4_programmatic_ceiling.py --seeds 0-4
...
from devsys.diagnostics.cross_substrate import shuffled_label_null  # noqa: E402
...
def run(cache_root: Path, seeds: list[int], probe_epochs: int = 300) -> dict:
    ...
    if CEILING_COLUMN not in columns:
        return {
            "experiment": "mot_at4_programmatic_ceiling",
            "contract": CONTRACT,
            "clipset": CLIPSET,
            "seeds": seeds,
