...
forgetting area, per devsys.diagnostics.continual_metrics.
...
Usage: python scripts/mot_pr2_plasticity_substrates.py --seeds 0-4
...
from devsys.diagnostics.continual_metrics import (  # noqa: E402
    adaptation_speed,
    backward_transfer,
    forgetting_area,
)
