...
Usage: python scripts/mot_ws1_agreement_vs_confidence.py --seeds 0-4
...
from devsys.diagnostics.noisy_tv import noisy_tv_diagnostic  # noqa: E402
from devsys.diagnostics.riskcov import auroc, risk_coverage, seed_ci, sign_flip_report  # noqa: E402
