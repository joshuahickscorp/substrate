...
Reuses the shipped ex2 helpers (devsys.experiments.ex2_latent_planning), does not edit them.
Writes runs/mot/dr6_rollout_planning.json.

Form per BLACKHOLE.md: no em dashes or en dashes (commas, colons, parentheses only).

Usage: PYTHONPATH=. .venv/bin/python scripts/mot_dr6_rollout_planning.py --seeds 0-4
"""
