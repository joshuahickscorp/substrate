#!/usr/bin/env python3
"""Build the sealed post-recovery Generation 1 evidence-synthesis program."""
...
DEFAULT_OUTPUT = REPO_ROOT / "configs/campaign/generation1_evidence_synthesis_recovery_v1.json"
PROGRAM_ID = "generation1-evidence-synthesis-recovery1"
PROGRAM_ROOT = f"runs/generation1/{PROGRAM_ID}"
RECOVERY_PROGRAM_ID = "generation1-empirical-cognitive-corpus-v2-recovery1"
...
def build_program() -> dict[str, Any]:
    ...
    authority_paths = sorted(
        {
            "scripts/build_generation1_synthesis_program.py",
