...
(WP-10; registry row mot_ws5_router_slot in registry/experiments.yaml, preregistration mirror
configs/experiment/mot_ws5.yaml).
...
Stream: real_task_stream class-incremental (as mot_dr2_sparse_real_pilot, same split rule).
...
Usage: python scripts/mot_ws5_slot_ablation_pilot.py --seeds 0-4
...
from devsys.diagnostics.continual_metrics import backward_transfer, forgetting_area
...
from devsys.shell.heads import MoEHead, moe_expert_hidden_for_dense, routing_entropy
from devsys.substrate.real_latent import real_task_stream
