#!/usr/bin/env python
"""MT7: beam/tree search over latent states vs greedy refinement (WP-04, EXECUTION_MANIFEST).
...
verifier trained as an across-depth error predictor, mot_dr9_verify_revise.train_backbone) drives a
...
Preregistered null (verbatim, manifest WP-04): MT7 search ties deeper greedy at matched total FLOPs
...
Usage: .venv/bin/python scripts/mot_mt7_beam_search.py --seeds 0-4
"""
...
def make_ambiguous_split(
    ...
    """The multi-answer / ambiguous-target regime the MT7 registry row asks for: easy samples sit on
