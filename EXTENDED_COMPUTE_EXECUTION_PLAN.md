...
```mermaid
flowchart TD
  R0["R0 Evidence identity"] --> P1["P1 CM7 objective pilot"]
  R0 --> U21["V-JEPA 2.1 integration"]
  R0 --> P2["P2 Natural referent pack"]
  U21 --> P3["P3 Learned vs random controls"]
  P2 --> P3
  P1 --> P4["P4 Capability-density surface"]
  P2 --> P4
  P3 --> P4
  P1 --> P5["P5 Dense vs factorized context"]
  P2 --> P5
  P1 --> P6["P6 Continual stream"]
  P2 --> P8["P8 Native A/V binding"]
  R0 --> P7["P7 Action and active perception"]
  R0 --> P9["P9 Self-model and accounting"]
  R0 --> P10S["P10 Simulation"]
  P10S --> P10B["P10 Bench specimens (L6)"]
  P4 --> HG["Hardware benefit/requirement gate"]
  P5 --> HG
  P6 --> HG
  P7 --> HG
  P8 --> HG
  P9 --> HG
  HG --> L3["Smallest validating rental, only if passed"]
```
