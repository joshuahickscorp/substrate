...
- Relation to custom design: stable-key retrieval is a doctrinal FREE LUNCH (frozen encoder), and the natural episodic-memory primitive for Mixture of Thinking.
...
9. Self-eval head. A small verifier/calibration head reading the ensemble disagreement, producing the epistemic signal that gates 5, 6, and the active-learning query in 1.18. This is also the honest-confidence output for Mixture of Thinking.
...
## 3. How the plasticity stack becomes part of Mixture of Thinking

Mixture of Thinking is the larger frame: multiple thinking modes routed by a controller. The plasticity stack contributes three things to it.
