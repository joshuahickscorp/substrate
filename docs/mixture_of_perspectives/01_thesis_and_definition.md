# Mixture of Perspectives: Thesis and Definition

Sections 1 and 2 of the Mixture of Perspectives (MoT) reframing of the Brain program. This document restates
...
The reframe from "frozen substrate plus tiny trainable shell" to "Mixture of Perspectives" is NOT a rebranding
...
Mixture of Perspectives claims that a small, frozen-substrate system can achieve higher capability DENSITY than
...
Seed-stability is mandatory (sign-flips published as instability, swept via mop.harness.sweep.run_sweep
...
## 2. Mixture of Perspectives, Defined Rigorously
