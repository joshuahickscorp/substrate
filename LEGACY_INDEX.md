...
| MOP_MAXIMUM_POTENTIAL_RESEARCH_2026_07.md | integrated research | preserve, evidence | current research synthesis and local boundary |
| MOP_POTENTIAL_ATLAS_2026_07.md | scored potential audit | preserve, evidence | 37-facet S/I/E/C atlas with local-to-10 paths |
| MOP_MAXIMUM_POTENTIAL_EXECUTION_PLAN.md | front-to-back execution | preserve, plan | active wave and measured escalation plan |
| MOP_MAXIMUM_POTENTIAL_GOAL.md | standing loop | preserve, ROOT | current autonomous execution prompt |
...
| STUDIO_HANDOFF.md | studio cold-start brief | demote (historical scenario) | current hardware decisions use the maximum-potential goal and live requirements |
...
| 10_compute_tiers.md | tier doctrine | demote (superseded hardware numbers; tiers still used) | current adaptive local profile and measured escalation gate govern |
...
| STUDIO_RUN_REPORT.md | studio scoreboard | archive (historical scenario) | current receipts and potential atlas supersede its pending-machine narrative |
| STUDIO_TURNKEY_PLAN.md | de-risk checklist | demote (historical scenario) | useful procedures survive through the adaptive local governor |
| M3PRO_RUN_REPORT.md | laptop maximization record | archive (mop_legacy) | corrected-record narrative |
| HANDOFF.md | cold-start brief + verdict ledger | demote (historical scenario) | current cold start is MOP_MAXIMUM_POTENTIAL_GOAL.md |
| EXECUTION_MANIFEST.md | original work-package plan | archive (mop_legacy) | superseded by SCAFFOLD.md; cites old brain/ path |
| STUDIO_GOAL_PROMPT.md | old /goal loop prompt | archive (historical scenario) | superseded by MOP_MAXIMUM_POTENTIAL_GOAL.md |
| POTENTIAL_AUDIT.md | adversarial self-audit | archive (mop_legacy) | its ceiling map fed the pivot |
| STUDIO_POTENTIAL_AUDIT.md | studio ceiling audit | demote (historical scenario) | hypotheses retained; hardware conclusions require live measured gates |
| CONDENSATION_PLAN.md | doc-shrink plan | preserve (operational) | must-not-condense list still binds |
| EXPAND_PHASE_PLAN.md | walls-to-experiments map | demote (historical scenario) | current expansion uses MOP_MAXIMUM_POTENTIAL_EXECUTION_PLAN.md |
| DEEP_RESEARCH_2026_07.md | literature brief | preserve (evidence) | PR9 certification lives here |
| SCAFFOLD.md | process A/B/C sequencing | demote (historical scenario) | current sequencing lives in MOP_MAXIMUM_POTENTIAL_EXECUTION_PLAN.md |
