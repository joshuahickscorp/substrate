...
- Maintained Python: 48,079 LOC; ceiling: 50,000.
- Verified net Python reduction: 357,118 LOC.
- Checklist: {"active": 49, "complete": 33, "partial": 9, "pending": 125, "verified": 43}.
...
- SEC-14: Entrypoint and script collapse (313 -> ~10 CLI verbs) -> collapse the remaining script and module command surfaces onto normal CLI verbs

## Recent green reductions

| tag | net LOC | batch |
| --- | ---: | --- |
| mop-collapse-controller-extension-v4 | 3,083 | superseded_extension_v4_recovery_v2_branch |
