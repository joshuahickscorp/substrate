...
- Branch `agent/mop-accretion-collapse` @ `33a7bd8` (base = current origin/main `a1d6be3`).
...
Total items: 228. By status: `{"complete": 14, "active": 49, "pending": 145, "partial": 8, "verified": 12}`.
...
| SEC-11 | 11 | region | active | STARSS23 first high-pressure region collapse (12-step process) | measure and collapse the next repeated STARSS producer/prereg lifecycle; preserve variant-specific hypotheses and decisive scoring |
