...
- Branch `agent/mop-accretion-collapse` @ `0936cc0` (base = current origin/main `a1d6be3`).
...
Total items: 226. By status: `{"complete": 14, "active": 49, "pending": 145, "partial": 8, "verified": 10}`.
...
| SEC-11 | 11 | region | active | STARSS23 first high-pressure region collapse (12-step process) | collapse repeated causal gate passes and marginal-matched noise controls; preserve provider state mathematics and sealed seeds |
