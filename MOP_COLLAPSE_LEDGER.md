...
- Branch `agent/mop-accretion-collapse` @ `e00d70f` (base = current origin/main `a1d6be3`).
...
Total items: 258. By status: `{"complete": 17, "active": 52, "pending": 137, "partial": 10, "verified": 42}`.
