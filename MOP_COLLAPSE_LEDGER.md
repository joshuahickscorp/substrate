...
- Branch `agent/mop-accretion-collapse` @ `3b2367e` (base = current origin/main `a1d6be3`).
...
Total items: 227. By status: `{"complete": 14, "active": 49, "pending": 145, "partial": 8, "verified": 11}`.
...
| SEC-11 | 11 | region | active | STARSS23 first high-pressure region collapse (12-step process) | collapse repeated fire-spread diagnostics and sealed prereg readers; preserve variant-specific scoring and historical digests |
