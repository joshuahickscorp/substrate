...
AUTHORITY = ROOT / "plans/substrate/tangible_next_launch/ODYSSEY_7D.authority.json"
SHARED_STORAGE_RESERVE = ROOT / "plans/substrate/tangible_next_launch/ODYSSEY_SHARED_STORAGE_RESERVE.draft.json"
LABEL = "org.substrate.odyssey7d.telegram"
PLIST = Path.home() / "Library/LaunchAgents" / f"{LABEL}.plist"
PREFLIGHT_LABEL = "org.substrate.odyssey-preflight.telegram"
PREFLIGHT_PLIST = ROOT / "plans/substrate/tangible_next_launch/ODYSSEY_PREFLIGHT.telegram.launchd.plist"
...
def preflight_snapshot() -> dict[str, Any]:
    ...
    frozen = _optional_json(ROOT / "plans/substrate/tangible_next_launch/ODYSSEY_FROZEN_BUILD.json") or {}
    transition = (
        verified_transition
    ...
    design = _optional_json(ROOT / "plans/substrate/tangible_next_launch/ODYSSEY_7D.hardened.draft.json") or {}
...
def prepare() -> dict[str, Any]:
    path = ROOT / "plans/substrate/tangible_next_launch/ODYSSEY_7D.telegram.launchd.template.plist"
