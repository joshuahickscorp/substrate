...
relation_decoding = linear-probe accuracy (devsys.diagnostics.linear_probe) of the relation
...
construction (devsys.diagnostics.substrate_ablation.frozen_random_projection), since this is a
