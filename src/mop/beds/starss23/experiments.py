    ...
    return seal_record(
        {
            ...
            "stop": {
                "decision": "paired_sign_flip_one_sided",
                "alpha": 0.05,
                "tie": "null",
                "min_reproductions": 3,
                "single_run_never_promotes": True,
            },
            "claims": {
                "ceiling": CLAIM,
...
COUNTING = _record(
    ...
    schema="mop-starss23-escs-count-bed/v1",
    ...
    metric="coasted concurrent-source count MAE, pooled frame micro-average",
    direction="lower",
    sesoi=0.02,
    seeds=(0, 1, 2, 3, 4),
    providers=("count_featurizer", "count_estimator", "count_referee"),
    treatments=("count_gate",),
    split={"rule": "room_disjoint", "train_fold": 3, "test_fold": 4},
    multiplicity={"kind": "none", "members": ()},
    verification="starss23_count_verifier",
)
