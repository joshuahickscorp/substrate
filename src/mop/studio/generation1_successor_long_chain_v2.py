...
from mop.studio.generation1_successor_future_chain_v2 import (
...
PROGRAM_ID = "generation1-successor-long-chain-v2"
RECEIPT_SCHEMA = "mop-generation1-successor-long-chain-start/v2"
