...
frontier_table delegates the Pareto math to mop.metrics.frontier so the report and the gate
agree on who wins.
"""
...
def frontier_table(points: list[dict]) -> str:
    ...
    computed by mop.metrics.frontier (the program's central metric) so this table and the
